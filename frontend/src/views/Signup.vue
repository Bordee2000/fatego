      ...
      <div class="column is-4">
        ...
        <div class="field">
          ...
          <template v-if="$v.username.$error">
            ...
            <p class="help is-danger" v-if="!$v.username.minLength">username to short</p>
            <p class="help is-danger" v-if="!$v.username.maxLength">username to long</p>
          </template>
        </div>
        ...
        <div class="field">
          ...
          <template v-if="$v.password.$error">
            ...
            <p class="help is-danger" v-if="!$v.password.minLength">Password to short</p>
            <p class="help is-danger" v-if="!$v.password.complexPassword">Password to easy</p>
          </template>
        </div>
        ...
        <div class="field">
          ...
          <template v-if="$v.confirm_password.$error">
            ...
            <p class="help is-danger" v-if="!$v.confirm_password.sameAs">Not same password</p>
          </template>
        </div>
        ...
        <div class="field">
          ...
          <template v-if="$v.mobile.$error">
            ...
            <p class="help is-danger" v-if="!$v.mobile.maxLength">Not Mobile Number</p>
          </template>
        </div>
        ...
        <div class="field">
          ...
          <template v-if="$v.first_name.$error">
            ...
            <p class="help is-danger" v-if="!$v.first_name.maxLength">Firstname is to long</p>
          </template>
        </div>
        ...
        <div class="field">
          ...
          <template v-if="$v.last_name.$error">
            ...
            <p class="help is-danger" v-if="!$v.last_name.maxLength">Lastname is to long</p>
          </template>
        </div>
