          ...
          <div class="field">
            ...
            <div class="columns">
              <div class="column">
                ...
                <div class="control">
                  <input v-model="data.atk" class="input" type="number" placeholder="less than 10000000 " />
                </div>
              </div>
              <div class="column">
                <label class="label">HP</label>
                <div class="control">
                  <input v-model="data.hp" class="input" type="number" placeholder="less than 10000000 " />
                </div>
              </div>
            </div>
            <div class="columns">
              ...
              <div class="column">
                ...
                <div class="control">
                  <input
                    ...
                    class="input"
                    type="number"
                    placeholder="less than 10000000"
                  />
                </div>
              </div>
              <div class="column">
